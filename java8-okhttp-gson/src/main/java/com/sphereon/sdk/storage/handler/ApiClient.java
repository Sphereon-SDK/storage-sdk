...
public class ApiClient {
    ...
    private String basePath = "https://gw.api.cloud.sphereon.com/bucket-storage/0.8";
    ...
    public ApiClient() {
        ...
        setUserAgent("Swagger-Codegen/0.8.9-SNAPSHOT/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://gw.api.cloud.sphereon.com/bucket-storage/0.8
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                ...
                try {
                    ...
                    RuntimeException rte = new RuntimeException("An error occurred in the onSuccess callback: " + t.getMessage(), t);
                    callback.onFailure(new ApiException(rte), response.code(), response.headers().toMultimap());
                    return;
                }
            }
        });
