...
------------ | ------------- | ------------- | -------------
**credentials** | [**Credentials**](Credentials.md) | The credentials that are used to connect with the backend storage location. |  [optional]
...
**backendLocation** | [**BackendLocation**](BackendLocation.md) | The storage region where the container and files are stored. This option is available for Google and Amazon Storage. For Azure is only possible to set the region when creating the storage account. |  [optional]
**id** | **String** |  |  [optional]
