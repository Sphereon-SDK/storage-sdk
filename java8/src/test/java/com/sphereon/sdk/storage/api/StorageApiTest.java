...
public class StorageApiTest {
    ...
    static {
        api.getApiClient().setAccessToken("07358f0a-3242-3083-97fe-fa544b09b21f");
    }
    ...
    public void getContainerInfoTest() throws ApiException {
        ContainerResponse response = api.getContainerInfo(XILLIO_CONFIGURATION_ID);
    ...
    public void getObjectTest() throws ApiException {
        ...
        byte[] response = api.getObject(XILLIO_CONFIGURATION_ID, "SANDBOX.md");
        Assert.assertNotNull(response);
    }
    ...
    public void listObjectsInFolderTest() throws ApiException {
        ObjectInfoResponse response = api.listObjects(XILLIO_CONFIGURATION_ID, "/");
        Assert.assertNotNull(response);
