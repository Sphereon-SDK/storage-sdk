...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Storage.ContainerRequest = factory(root.Storage.ApiClient);
  }
   ...
   * @module SphereonSdkStorage/model/ContainerRequest
   * @version 0.6.0
   */

  /**
   * Constructs a new <code>ContainerRequest</code>.
   * @alias module:SphereonSdkStorage/model/ContainerRequest
   * @class
   */
   ...
   * @param {module:SphereonSdkStorage/model/ContainerRequest} obj Optional instance to populate.
   * @return {module:SphereonSdkStorage/model/ContainerRequest} The populated <code>ContainerRequest</code> instance.
   */
