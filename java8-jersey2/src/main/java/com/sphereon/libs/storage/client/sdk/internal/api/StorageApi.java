package com.sphereon.libs.storage.client.sdk.internal.api;

import com.sphereon.libs.storage.client.sdk.internal.handler.ApiClient;
import com.sphereon.libs.storage.client.sdk.internal.model.BackendRequest;
import com.sphereon.libs.storage.client.sdk.internal.handler.ApiException;
import com.sphereon.libs.storage.client.sdk.internal.handler.Configuration;
import com.sphereon.libs.storage.client.sdk.internal.handler.Pair;

import javax.ws.rs.core.GenericType;

import com.sphereon.libs.storage.client.sdk.internal.model.BackendResponse;
import com.sphereon.libs.storage.client.sdk.internal.model.ContainerResponse;
import com.sphereon.libs.storage.client.sdk.internal.model.ContainerRequest;
import java.io.File;
...
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2017-07-31T18:29:48.458+02:00")
public class StorageApi {
  ...
  public ContainerResponse getContainerInfo(String containerId) throws ApiException {
    ...
    // verify the required parameter 'containerId' is set
    if (containerId == null) {
      throw new ApiException(400, "Missing the required parameter 'containerId' when calling getContainerInfo");
    }
